...
<div class="w3-container" id="menu">
  <div class="w3-content" style="max-width:700px">  
    <div class="w3-row w3-center  w3-padding">  
      <form action="${pageContext.request.contextPath}/user/registerUser.do" method="post" class="pageForm w3-container w3-card-4 w3-light-grey w3-text-teal w3-margin" style="max-width:700px">
        ...
        <button type="submit" class="w3-btn w3-section w3-green w3-ripple w3-padding w3-margin-right">확인</button>
