...
public interface RoomDao {
	 ...
	 * @return 전체 방 목록
	 */
	List<Room> retrieveRoomAllByRowNum(String startNum, String endNum);
	 ...
	 */
	List<Room> retrieveRoomByCategory(Category category, String startNum, String endNum);
	 ...
	 */
	List<Room> retrieveRoomByTitleForSearch(String keyword, String startNum, String endNum);
