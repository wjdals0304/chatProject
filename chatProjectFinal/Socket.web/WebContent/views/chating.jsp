...
<body>
 ...
 <form id="form">
  ...
  <div class="user_box w3-round-large w3-container w3-animate-zoom" >
  	<div class="w3-card-4">
    <div class="w3-container w3-center w3-teal" style="width: 250px;">
   	 <h5>사용자 정보</h5>
  	</div>
    <div class="w3-container w3-white" >
      <ul class="w3-ul-chat">
...
ex_filename.onchange = function() {
	fileWs = new WebSocket("ws://192.168.0.78:8081/Socket.web/upload");
    ...
    var jsonData = JSON.parse(event.data);
     ...
     if(jsonData.granting  == "granting"){
	  ...
	  if(typeof jsonData.file != "undefined" ){
	    ...
	    $("#chatMessage").append("<div style='text-align:center; font-size:15px; color:white;'>"+fromId+"님이 <b>["+fileName +"]</b> 업로드 했습니다 .</div><div class='blank'></div>'");
	  }
	
     
     var messageContnets =jsonData.message
     if(typeof messageContnets !="undefined"){
